...
const COPY = {
  en: {
    ...
    'b6.vo': 'Free, offline, and nothing to sign up for. When you want company, the Check-in Club is one tab away. Tadapop.',
  ...
  zh: {
    ...
    'n1.cap1': 'Tada！想養成好習慣？',
    'n1.cap2': '又有一件事，<span class="hi">你想做很久了吧？</span>',
    'n1.cap3': '先別急著靠意志力。',
    'n1.cap4': '因為一個人做……<span class="hi">真的太容易放過自己了。</span>',
    'n1.vo': 'Tada！想養成好習慣？又有一件事，你想做很久了吧？先別急著靠意志力。因為一個人做……真的太容易放過自己了。',
    ...
    'n2.joinCode': '我有邀請碼',
    'n2.cap1': '挑一件你真的想做到的事，',
    'n2.cap2': '再找幾個<span class="hi">不會輕易放過你</span>的朋友。',
    'n2.cap3': '這裡就是 <span class="hi">Tadapop 打卡俱樂部</span>。',
    'n2.cap4': '一群人互相盯著，<span class="go">一起把想做的事真的做完。</span>',
    'n2.cap5': '而且這不是公開社群。',
    'n2.cap6': '只有你邀請的人進得來，<span class="go">外面的人什麼都看不到。</span>',
    'n2.vo': '挑一件你真的想做到的事，再找幾個不會輕易放過你的朋友。這裡就是 Tadapop 打卡俱樂部。一群人互相盯著，一起把想做的事真的做完。而且這不是公開社群。只有你邀請的人進得來，外面的人什麼都看不到。',
    ...
    'c1.cap2': '<span class="go">拖成你要的順序</span>。',
    'c1.vo': '分類就照你自己的想法來分，拖成你要的順序。',
    ...
    'c2.cap1': '用現成的範本是最快的起手式，或者自己寫任務。',
    'c2.cap2': '按下<span class="hi">加入</span>，它就<span class="go">出現在今天的任務裡</span>。',
    'c2.vo': '用線成的範本是最快的起手式，或者自己寫任務。按下加入，它就出現在今天的任務裡。',
    ...
    'a2.mRead': '30 天 \u00b7 3 位成員',
    'a2.proofTag': '成果',
    'a2.cap1': '挑一件你<span class="hi">講了很久、卻一直沒做到</span>的事。',
    'a2.cap2': '一週運動三次、每天 11 點前睡覺、週末讀完一本書——<span class="go">都可以</span>。',
    'a2.vo': '挑一件你講了很久、卻一直沒做到的事。一週運動三次、每天 11 點前睡覺、週末讀完一本書——都可以。',
    ...
    'a1.cap1': '想自己開一團？<span class="hi">那你就是主辦人</span>，規則你來訂。',
    'a1.cap2': '幫挑戰取個名字、設定玩法、決定多久做一次。',
    'a1.vo': '想自己開一團？那你就是主辦人，規則你來訂。幫挑戰取個名字、設定玩法、決定多久做一次。',
    ...
    'a3.btnCreate': '建立',
    'a3.btnCancel': '取消',
    'a3.cap1': '打卡要不要附<span class="hi">照片、影片，還是兩個都要</span>。',
    'a3.cap2': '接著，再把那幾個<span class="hi">最不能放你水</span>的人拉進來。',
    'a3.cap3': '按下<span class="go">建立</span>——俱樂部就開張了。',
    'a3.vo': '打卡要不要附照片、影片，還是兩個都要。接著，再把那幾個最不能放你水的人拉進來。按下建立——俱樂部就開張了。',
    ...
    'a4.r3': '之後只留一張定格',
    'a4.cap1': '影片也不用認真拍。',
    'a4.cap2': '手機隨手錄就好，<span class="hi">兩分鐘以內</span>。',
    'a4.cap3': '影片保留七天，之後<span class="hi">只留下一張畫面</span>。',
    'a4.cap4': '<span class="go">留下紀錄，不留下黑歷史。</span>',
    'a4.vo': '影片也不用認真拍。手機隨手錄就好，兩分鐘以內。影片保留七天，之後只留下一張畫面。留下紀錄，不留下黑歷史。',

    'n3.rulesLabel': '玩法',
    'n3.rules': '每天運動四十分鐘，連續五十天。\n一天沒做到，罰一百入碗。\n最後用這筆錢大家一起去吃飯。',
    'n3.cap1': '所有規則，<span class="hi">大家加入前都看得到</span>。',
    'n3.cap2': '所以要不要玩真的一點？',
    'n3.cap3': '沒做到，就丟一點錢進<span class="hi">共同基金</span>，',
    ...
    'n3.vo': '所有規則，大家加入前都看得到。所以要不要玩真的一點？沒做到，就丟一點錢進共同基金，最後大家一起拿去吃飯、慶功。不想玩錢也沒關係，也可以自己想一些有趣的成伐——輸的人請喝咖啡、請吃飯，或做一件大家都會很期待看到的事。',
    ...
    'n4.checkedIn': '今天完成 ✓',
    'n4.undo': '取消打卡',
    'n4.cap1': '然後每天，其實就只剩下一個問題：',
    'n4.cap2': '<span class="hi">「今天，打卡了沒？」</span>',
    'n4.cap3': '做完，就<span class="go">回來打卡</span>。',
    'n4.vo': '然後每天，其實就只剩下一個問題：「今天，打卡了沒？」做完，就回來打卡。',

    /* ---- n5 ---- */
    'n5.proofLabel': '成果 · 所有人都看得到',
    'n5.cap1': '如果這一團有規定要附證據，',
    'n5.cap2': '就拍張照片，或錄一小段影片。',
    'n5.cap3': '不是為了抓作弊。',
    'n5.cap4': '而是當你看到大家真的都做了……',
    'n5.cap5': '<span class="go">你真的很難繼續躺著。</span>',
    'n5.vo': '如果這一團有規定要附證據，就拍張照片，或錄一小段影片。不是為了抓作弊。而是當你看到大家真的都做了……你真的很難繼續躺著。',

    /* ---- n6 ---- */
    'n6.cap1': '然後排行榜就<span class="hi">放在那裡</span>。',
    'n6.cap2': '誰超前、誰快掉隊，<span class="go">一眼就知道</span>。',
    'n6.cap3': '不用再有一個人每天在群組裡問：',
    'n6.cap4': '「欸，你今天到底做了沒？」',
    'n6.cap5': '因為排行榜自己……<span class="hi">就已經很有壓力了。</span>',
    'n6.vo': '然後排行榜就放在那裡。誰超前、誰快掉隊，一眼就知道。不用再有一個人每天在群組裡問：「欸，你今天到底做了沒？」因為排行榜自己……就已經很有壓力了。',

    /* ---- n7 ---- */
    'n7.cap1': '等挑戰結束，把共同基金拿去<span class="hi">吃飯、喝東西、一起慶功</span>。',
    'n7.cap2': '但真正爽的不是那頓飯。',
    'n7.cap3': '是你回頭一看才發現——',
    'n7.cap4': '<span class="go">欸？這次我居然真的撐下來了。</span>',
    'n7.vo': '等挑戰結束，把共同基金拿去吃飯、喝東西、一起慶功。但真正爽的不是那頓飯。是你回頭一看才發現——欸？這次我居然真的撐下來了。',
    ...
    /* ---- n9 ---- */
    'n9.cap1': '而且加入別人的挑戰，<span class="go">永遠免費</span>。',
    'n9.cap2': '所以，別再等下星期一。',
    'n9.cap3': '<span class="hi">找三個人，開一團。</span>',
    'n9.cap4': '把那件講很久的事，這次真的做完。Tadapop。',
    'n9.vo': '而且加入別人的挑戰，永遠免費。所以，別再等下星期一。找三個人，開一團。把那件講很久的事，這次真的做完。Tadapop。',
    ...
    /* ---- 單人版剪輯 (b1..b6) ---- */
    'b1.cap1': 'Tadapop 是一份<span class="hi">督促提醒自己的任務清單</span>。',
    'b1.vo': 'Tadapop 是一份督促提醒自己的任務清單。',

    'b2.cap1': '把你想養成的習慣、<span class="hi">固定需要確認的任務</span>放上去。',
    'b2.cap2': '打個勾、計次，或<span class="go">按下計時器，專心做到鈴響</span>。',
    'b2.vo': '把你想養成的習慣、固定需要確任的任務放上去。打個勾、計次，或按下計時器，專心做到玲響。',
    ...
    'b3.vo': '整天清空才拿得到一點 踢點數。漏一項就沒有，這裡算的是一整天，不是單項。',
    ...
    'b4.best': '最佳 380 天',
    'b4.thisWeek': '本週',
    'b4.cap1': '<span class="go">今天封存，</span>每日達標連續紀錄加一天。',
    'b4.cap2': '中斷了也沒人數落你，<span class="hi">重新開始就好。</span>',
    'b4.vo': '今天封存，每日達標連續紀錄加一天。中斷了也沒人鼠落你，重新開始就好。',

    'b5.cap1': '然後某天回頭看這一年，整面格子都<span class="go">綠了</span>，',
    'b5.cap2': '原來，<span class="hi">你也可以堅持下去！</span>',
    'b5.vo': '然後某天回頭看這一年，整面格子都綠了，原來，你也可以堅持下去！',

    'b6.cap1': '免費、離線可用，<span class="go">完全不用註冊</span>。',
    'b6.cap2': '想找人一起，<span class="hi">打卡俱樂部就在隔壁分頁</span>。Tadapop。',
    'b6.vo': '免費、離線可用，完全不用註冊。想找人一起，打卡俱樂部就在隔壁分業。Tadapop。',
...
const CAP_AT = {
  ...
  zh: {
    n1: [0, 2.9, 6.1, 8.2], n2: [0, 3.1, 6.9, 11.2, 16.2, 19.0], n3: [0, 3.0, 5.3, 8.3, 11.1, 16.0], n4: [0, 3.5, 6.2], n5: [0, 2.6, 5.8, 7.4, 10.3],
    n6: [0, 2.8, 6.5, 9.6, 12.5], n7: [0, 6.0, 8.7, 11.0], n8: [0, 3.8], n9: [0, 3.9, 6.8, 8.8],
    b1: [0], b2: [0, 4.8], b3: [0, 4.1], b4: [0, 4.6], b5: [0, 4.7], b6: [0, 3.3],
